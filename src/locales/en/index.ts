const en = {
  ...
  auth: {
    ...
    login: {
      ...
      motivationalText: "The body achieves what the\nmind believes",
  ...
  workouts: {
    ...
    exerciseCount_plural: "{{count}} exercises",
    duration: "{{minutes}} min",
    restTime: "Rest: {{seconds}}s",
    setsReps: "{{sets}} sets × {{reps}} reps",
    emptyState: "No workouts yet. Create your first one!",
    filters: {
      all: "All",
      favorites: "Favorites",
      recent: "Recent",
